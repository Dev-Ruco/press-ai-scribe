    ...
    <section className="container mx-auto px-4 py-8 md:py-16 flex flex-col md:flex-row items-center gap-4 md:gap-8">
      ...
      >
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-gray-100 to-gray-200 rounded-full text-xs md:text-sm font-medium">
          <Sparkles className="w-3 h-3 md:w-4 md:h-4 text-gray-700" /> Revolutionizing journalism
        </div>
        <h1 className="text-2xl md:text-4xl lg:text-5xl font-playfair font-bold leading-tight text-black">
          Transform ideas into <span className="relative inline-block">
            <span className="relative z-10">articles</span>
            <span className="absolute bottom-2 left-0 right-0 h-2 bg-gradient-to-r from-gray-200 to-gray-300 -z-10 transform -rotate-1"></span>
          </span> in seconds
        </h1>
        <p className="text-sm md:text-base text-gray-600 max-w-xl">
          Create professional journalistic content 10x faster with PRESS AI, the tool that combines artificial intelligence 
          with your editorial expertise to redefine your workflow.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 items-center pt-4">
          ...
          <div className="hidden sm:flex items-center gap-2 text-gray-600 text-xs md:text-sm mt-2 sm:mt-0">
            ...
            <span>300+ journalists already using it</span>
          </div>
        </div>
      </div>
