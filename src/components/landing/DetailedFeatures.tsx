...
import { Upload, FileText, MessageSquare, Newspaper, Link as LinkIcon, Sparkles, Rocket, Lightbulb, TrendingUp } from 'lucide-react';
  ...
  return (
    <section ref={ref} className="container mx-auto px-4 py-24">
      <div className={`transition-all duration-1000 transform ${
        ...
        <h2 className="text-4xl font-playfair font-bold text-center mb-6 text-black">Recursos Que Transformam o Seu Jornalismo</h2>
        ...
        <div className="mt-20 bg-black rounded-xl p-8 text-white max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              <TrendingUp className="h-12 w-12 mb-4" />
              <h3 className="text-2xl font-bold mb-4">Impacto Comprovado</h3>
              <p className="mb-6">
              ...
              <div className="flex items-center gap-4">
                <div>
                  ...
                  <div className="text-sm text-white/70">mais artigos</div>
                </div>
                <div className="h-12 w-px bg-white/20"></div>
                <div>
                  <div className="text-3xl font-bold">-70%</div>
                  <div className="text-sm text-white/70">tempo de produção</div>
                </div>
                <div className="h-12 w-px bg-white/20"></div>
                <div>
                  <div className="text-3xl font-bold">+40%</div>
                  <div className="text-sm text-white/70">engajamento</div>
                </div>
              </div>
            </div>
            <div className="flex-1">
