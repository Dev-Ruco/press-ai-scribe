    ...
    <section ref={ref} className="py-10 bg-white overflow-hidden">
      <div className="container mx-auto px-4 mb-6">
        <p className="text-center text-gray-600 font-medium">
          {language === 'pt-MZ' ? 'Empresas de mídia que confiam em nossa tecnologia' : 'Trusted by leading media companies'}
        </p>
      </div>
        ...
        <div className="flex overflow-hidden">
          <div ref={sliderRef} className="flex items-center space-x-16 whitespace-nowrap min-w-max">
            ...
            {logos.map((logo, index) => (
              <div key={`logo-1-${index}`} className="h-12 flex items-center px-4 grayscale hover:grayscale-0 transition-all duration-300">
            ...
            {logos.map((logo, index) => (
              <div key={`logo-2-${index}`} className="h-12 flex items-center px-4 grayscale hover:grayscale-0 transition-all duration-300">
